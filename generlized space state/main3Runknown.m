...
f = @(x, n ,d) [-1/L*x(2)*T+d*Vin/L*T+n(1)+x(1);...
            ...
            x(7)+n(7)] ;
h = @(x,t,v) [0 1 0 0 2*cos(w*t) -2*sin(w*t) 0;...
              1 0 2*cos(w*t) -2*sin(w*t) 0 0 0]*x+[v(1);v(2)];
 
h2 = @(x,t,v) [0 1 0 0 2*cos(w*t) -2*sin(w*t) 0]*x + v;
% EKF pax(7)ametex(7)
...
Jh = @(t) [0 1 0 0 2*cos(w*t) -2*sin(w*t) 0;
            1 0 2*cos(w*t) -2*sin(w*t) 0 0 0];
        
Jh2= @(t) [0 1 0 0 2*cos(w*t) -2*sin(w*t) 0];

v_sd = 0;
n_sd = 0.1;

Rv = diag([v_sd^2 v_sd^2 v_sd^2 v_sd^2 v_sd^2 v_sd^2 v_sd^2]);
Rn = diag([n_sd^2 n_sd^2]);

Rn2 = n_sd^2;
x_h_k0_EKF = [0;0;0;0;0;0;1];
P_k0_EKF = 0.1*eye(n);
x_1 = x_h_k0_EKF ;
x_k0 = x_h_k0_EKF;
p_1 = P_k0_EKF ;